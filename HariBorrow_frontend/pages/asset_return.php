...
<script>
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      document.getElementById('s-loan-status').textContent = 'Pending Review';
      ...
      // Show toast
      showReturnToast('Return Requested has been Submitted', 'Your return is in review. You\'ll be notified once approved.');
    } catch (error) {
