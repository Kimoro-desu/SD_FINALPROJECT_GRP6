  ...
  <style>
    ...
    *::after {
    ...
    .bg-mesh {
      ...
      height: 100vh;
      z-index: 0;
      /* background-image: url('bg-aesthetic.jpg'); */
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="nav-menu">
      ...
      <a href="pendingrequest_approval.php" class="nav-link">
      ...
      <a href="active_transactions.php" class="nav-link">
        <i class="ph ph-clock-counter-clockwise"></i> Active Transactions
      </a>
  ...
  <script>
    ...
    async function loadAdminDashboard() {
      ...
      // Recent transactions
      try {
        const histRes = await window.api.authenticatedFetch('/api/transactions/history.php');
        ...
        const rows = history.slice(0, 8).map(tx => {
          ...
          const status = tx?.is_overdue ? 'Overdue' : statusRaw;
