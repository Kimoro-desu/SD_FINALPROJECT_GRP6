...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <a href="pendingrequest_approval.php" class="nav-link active"><i class="ph ph-bell-ringing"></i> Pending Requests
                <span class="nav-badge" id="pendingNavBadge" style="display:none;">0</span>
            </a>
            <a href="active_transactions.php" class="nav-link"><i class="ph ph-clock-counter-clockwise"></i> Active Transactions</a>
