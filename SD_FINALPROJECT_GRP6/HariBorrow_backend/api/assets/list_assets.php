...
$query = "SELECT a.Asset_ID, a.Lender_ID, a.asset_name, a.asset_type, a.description, a.meetup_location, a.proposed_penalty_amount, a.daily_penalty, a.penalty_type, a.availability, a.time_created, a.asset_image,
